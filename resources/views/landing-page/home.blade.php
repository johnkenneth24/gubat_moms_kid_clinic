    ...
    <div class="container">
      ...
      <div class="row pt-5">
        ...
        <div class="col-md-4">
          <div class="card h-100">
            <div class="card-body">
              <h5 class="card-title text-uppercase" style="color: #373737">Vaccination & Baby Check-up</h5>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="about-text">
            ...
            <p style="color: #0451b6"><i class="bi bi-envelope-at-fill"></i></i> gubat_momkidsclinic@mail.com</p>
