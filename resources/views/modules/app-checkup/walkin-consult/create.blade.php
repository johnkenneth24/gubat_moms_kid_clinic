              ...
              <div class="card-header d-flex align-items-center justify-content-between pb-3">
                  <div class="card-title p-0 mb-0 d-flex align-item-center">
                      ...
                      <h5 class="card-header ms-2 p-0 text-uppercase" style="line-height: 1.5;"><span
                              class="text-primary">{{ $walkin->full_name }}</span> CONSULTATION</h5>
                  </div>
                  <div class="card-tool">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <textarea class="form-control @error('medication_intake') is-invalid @enderror" id="" name="medication_intake"
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <textarea class="form-control @error('vaccine_received') is-invalid @enderror" name="vaccine_received" id=""
                                  rows="3" placeholder="Type here..."></textarea>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <textarea class="form-control @error('diagnosis') is-invalid @enderror" name="diagnosis" id="" rows="3"
            ...
            <div class="col-lg-12">
                <div class="card p-2">
                    <div class="card-header d-flex align-items-center justify-content-between ">
                        <div class="card-title p-0 mb-0 d-flex align-item-center">
                            <h5 class="card-header ms-2 p-0 text-uppercase" style="line-height: 1.5;"><span
                                    class="text-primary">{{ $walkin->full_name }}</span> Personal Information</h5>
                        </div>
                        <div class="card-tool">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text"
                                        ...
                                        name="firstname" value="{{ $walkin->firstname }}">
                                    @error('firstname')
                                        <div class="invalid-feedback mt-0" style="display: inline-block !important;">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text"
                                        ...
                                        value="{{ $walkin->middlename }}" placeholder="" name="middlename">
                                    @error('middlename')
                                        <div class="invalid-feedback mt-0" style="display: inline-block !important;">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text"
                                        ...
                                        value="{{ $walkin->lastname }}" placeholder="" name="lastname">
                                    @error('lastname')
                                        <div class="invalid-feedback mt-0" style="display: inline-block !important;">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input readonly type="date" id="birthdate"
                                        ...
                                        value="{{ $walkin->birthdate->format('Y-m-d') }}" placeholder=""
                                        name="birthdate">
                                    @error('birthdate')
                                        <div class="invalid-feedback mt-0" style="display: inline-block !important;">
                                            {{ $message }}
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input readonly type="number" id="age"
                                        ...
                                        value="{{ $walkin->age }}" placeholder="0" name="age">
                                    @error('age')
                                        <div class="invalid-feedback mt-0" style="display: inline-block !important;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled id=""
                                        ...
                                        @foreach ($gender as $genders)
                                            <option value="{{ $genders }}" @selected($genders == $walkin->gender)>
                                                {{ $genders }}</option>
                                        @endforeach
                                    </select>
                                    @error('gender')
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id=""
                                        ...
                                        value="{{ $walkin->address }}" placeholder="" name="address">
                                    @error('address')
                                        <div class="invalid-feedback mt-0" style="display: inline-block !important;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="number" id=""
                                            ...
                                            value="{{ $walkin->weight }}" placeholder="" name="weight">
                                        @error('weight')
                                            <div class="invalid-feedback mt-0" style="display: inline-block !important;">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="number" id=""
                                            ...
                                            value="{{ $walkin->height }}" placeholder="" name="height">
                                        @error('height')
                                            <div class="invalid-feedback mt-0" style="display: inline-block !important;">
                                                {{ $message }}
                                            </div>
